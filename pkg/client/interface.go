...
type Client interface {
	...
	LoadSecretToTMPFS(ctx context.Context, secretRequest api_model.SecretPostRequest) (err error, errCode int)
	...
	UnloadSecretFromTMPFS(ctx context.Context, secretRequest api_model.SecretPostRequest) (err error, errCode int)
}
